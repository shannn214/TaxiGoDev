...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        guard taxiGoManager.checkUserToken() == nil else {
            ...
            if now > expiredTime {
                ...
                TaxiGoManager.shared.refreshToken { (isValid) in
                    ...
                    if isValid {
                        ...
                        taxiGoManager.taxiGo.auth.accessToken = taxiGoManager.checkUserToken()
    ...
    func application(_ app: UIApplication, open url: URL, options: [UIApplication.OpenURLOptionsKey : Any] = [:]) -> Bool {
        ...
        taxiGoManager.taxiGo.auth.authCode = taxiGoManager.taxiGo.auth.getAuthCode(url: url)
        taxiGoManager.getAccessToken()
